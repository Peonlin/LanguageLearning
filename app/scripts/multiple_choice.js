...
function initial(){
  ...
  $('.plain').click(function(){
    if($(this).find('.horn').hasClass('press')){
      $(this).find('.horn').removeClass('press');
      $(this).find('.horn').attr('src','../imgs/icon_sound.png'); 
    }
    else{
      $(this).find('.horn').addClass('press');
      $(this).find('.horn').attr('src','../imgs/icon_sound_press.png'); 
    }
  });
